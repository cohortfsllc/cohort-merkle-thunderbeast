...
namespace
{
	...
	int test_tree_size()
	{
		...
		// width=0x7FFFFFFF
		test_check_equal(hash_tree<0x7FFFFFFF>::size(0), 0);
		test_check_equal(hash_tree<0x7FFFFFFF>::size(1), 1);
		test_check_equal(hash_tree<0x7FFFFFFF>::size(2), 0x80000000);
		test_check_equal(hash_tree<0x7FFFFFFF>::size(3), 0x3FFFFFFF80000001);
		// width=0xFFFFFFFF
		test_check_equal(hash_tree<0xFFFFFFFF>::size(0), 0);
		test_check_equal(hash_tree<0xFFFFFFFF>::size(1), 1);
		test_check_equal(hash_tree<0xFFFFFFFF>::size(2), 0x100000000);
		test_check_equal(hash_tree<0xFFFFFFFF>::size(3), 0xFFFFFFFF00000001);
		return 0;
	}
