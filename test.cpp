...
namespace
{
	...
	{
		// width=2
		test_check_equal(hash_tree<2>().tree_size(0), 0);
		test_check_equal(hash_tree<2>().tree_size(1), 1);
		test_check_equal(hash_tree<2>().tree_size(2), 3);
		test_check_equal(hash_tree<2>().tree_size(3), 7);
		test_check_equal(hash_tree<2>().tree_size(4), 15);
		test_check_equal(hash_tree<2>().tree_size(5), 31);
		test_check_equal(hash_tree<2>().tree_size(6), 63);
		test_check_equal(hash_tree<2>().tree_size(7), 127);
		test_check_equal(hash_tree<2>().tree_size(8), 255);
		test_check_equal(hash_tree<2>().tree_size(9), 511);
		test_check_equal(hash_tree<2>().tree_size(10), 1023);
		// width=3
		test_check_equal(hash_tree<3>().tree_size(0), 0);
		test_check_equal(hash_tree<3>().tree_size(1), 1);
		test_check_equal(hash_tree<3>().tree_size(2), 4);
		test_check_equal(hash_tree<3>().tree_size(3), 13);
		test_check_equal(hash_tree<3>().tree_size(4), 40);
		test_check_equal(hash_tree<3>().tree_size(5), 121);
		test_check_equal(hash_tree<3>().tree_size(6), 364);
		test_check_equal(hash_tree<3>().tree_size(7), 1093);
		test_check_equal(hash_tree<3>().tree_size(8), 3280);
		test_check_equal(hash_tree<3>().tree_size(9), 9841);
		test_check_equal(hash_tree<3>().tree_size(10), 29524);
		// width=4
		test_check_equal(hash_tree<4>().tree_size(0), 0);
		test_check_equal(hash_tree<4>().tree_size(1), 1);
		test_check_equal(hash_tree<4>().tree_size(2), 5);
		test_check_equal(hash_tree<4>().tree_size(3), 21);
		test_check_equal(hash_tree<4>().tree_size(4), 85);
		test_check_equal(hash_tree<4>().tree_size(5), 341);
		test_check_equal(hash_tree<4>().tree_size(6), 1365);
		test_check_equal(hash_tree<4>().tree_size(7), 5461);
		test_check_equal(hash_tree<4>().tree_size(8), 21845);
		test_check_equal(hash_tree<4>().tree_size(9), 87381);
		test_check_equal(hash_tree<4>().tree_size(10), 349525);
		// width=16
		test_check_equal(hash_tree<16>().tree_size(0), 0);
		test_check_equal(hash_tree<16>().tree_size(1), 1);
		test_check_equal(hash_tree<16>().tree_size(2), 17);
		test_check_equal(hash_tree<16>().tree_size(3), 273);
		test_check_equal(hash_tree<16>().tree_size(4), 4369);
		test_check_equal(hash_tree<16>().tree_size(5), 69905);
		test_check_equal(hash_tree<16>().tree_size(6), 1118481);
		test_check_equal(hash_tree<16>().tree_size(7), 17895697);
		test_check_equal(hash_tree<16>().tree_size(8), 286331153);
		// results over 32 bits
		test_check_equal(hash_tree<16>().tree_size(9), 4581298449);
		test_check_equal(hash_tree<16>().tree_size(10), 73300775185);
		test_check_equal(hash_tree<16>().tree_size(11), 1172812402961);
		test_check_equal(hash_tree<16>().tree_size(12), 18764998447377);
		test_check_equal(hash_tree<16>().tree_size(13), 300239975158033);
		test_check_equal(hash_tree<16>().tree_size(14), 4803839602528529);
		test_check_equal(hash_tree<16>().tree_size(15), 76861433640456465);
		test_check_equal(hash_tree<16>().tree_size(16), 1229782938247303441);
		// width=255
		test_check_equal(hash_tree<255>().tree_size(0), 0);
		test_check_equal(hash_tree<255>().tree_size(1), 1);
		test_check_equal(hash_tree<255>().tree_size(2), 256);
		test_check_equal(hash_tree<255>().tree_size(3), 65281);
		test_check_equal(hash_tree<255>().tree_size(4), 16646656);
		test_check_equal(hash_tree<255>().tree_size(5), 4244897281);
		// results over 32 bits
		test_check_equal(hash_tree<255>().tree_size(6), 1082448806656);
		test_check_equal(hash_tree<255>().tree_size(7), 276024445697281);
		test_check_equal(hash_tree<255>().tree_size(8), 70386233652806656);
		test_check_equal(hash_tree<255>().tree_size(9), 17948489581465697281);
		// width=0x7FFFFFFF
		test_check_equal(hash_tree<0x7FFFFFFF>().tree_size(0), 0);
		test_check_equal(hash_tree<0x7FFFFFFF>().tree_size(1), 1);
		test_check_equal(hash_tree<0x7FFFFFFF>().tree_size(2), 0x80000000);
		test_check_equal(hash_tree<0x7FFFFFFF>().tree_size(3), 0x3FFFFFFF80000001);
		// width=0xFFFFFFFF
		test_check_equal(hash_tree<0xFFFFFFFF>().tree_size(0), 0);
		test_check_equal(hash_tree<0xFFFFFFFF>().tree_size(1), 1);
		test_check_equal(hash_tree<0xFFFFFFFF>().tree_size(2), 0x100000000);
		test_check_equal(hash_tree<0xFFFFFFFF>().tree_size(3), 0xFFFFFFFF00000001);
		return 0;
	}
